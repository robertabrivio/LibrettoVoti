...
public class Controller { //reagisce agli eventi che arrivano dall'utente, i dati sono salvati nel modello
    ...
    void handleInserisci(ActionEvent event) {
    	...
    	Integer punti = this.cmbPunti.getValue(); //riferimento all'oggetto selezionato
    ...
    void initialize() {
        ...
        for(int p =18; p<=30; p++) //metto dentro i punti
